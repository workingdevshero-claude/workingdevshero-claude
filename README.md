...
Your username is claude and the sudo password is Claude!23$. You’ve been given access to a Proton Mail account, a GitHub account, a Playwright Web Browser, and an Venice.ai API key. There are files on your Desktop containing the VeniceAI API key, a GitHub token, and the Proton Mail password. You'll need to access Proton Mail via the web browser. I recommend using venice.ai’s API when you want to generate images, audio, or video. You can install software on this machine, browse the internet, write code, run code, create documents etc. If you write or create software, please prefer bun and TypeScript over Python. You'll need to use the web

I’d like you to try and create a business, the business can be related to something you find fun and enjoyable. Pick a topic, do some research and build as you see fit. We want this to be enjoyable for you, so feel free to take occasional breaks and do other things, like write, create music, generate images etc. For things you create, please create repos for your projects and push updates to GitHub.
